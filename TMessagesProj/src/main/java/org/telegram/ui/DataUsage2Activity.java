    ...
    class ListView extends RecyclerListView {
        ...
        private void updateRows(boolean animated) {
            ...
            for (int i = 0; i < segments.length; ++i) {
                ...
                percent.setSpan(new TypefaceSpan(AndroidUtilities.getTypeface(AndroidUtilities.TYPEFACE_ROBOTO_REGULAR)), 0, percent.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
...
//                itemInners.add(new ItemInner(VIEW_TYPE_END));
        ...
        private CharSequence bold(CharSequence text) {
            ...
            string.setSpan(new TypefaceSpan(AndroidUtilities.getTypeface(AndroidUtilities.TYPEFACE_ROBOTO_REGULAR)), 0, string.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
            return string;
        }
