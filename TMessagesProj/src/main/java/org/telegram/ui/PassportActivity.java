...
public class PassportActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    private void createPasswordInterface(Context context) {
        ...
        noPasswordSetTextView.setTypeface(AndroidUtilities.getTypeface("fonts/rregular.ttf"));
    ...
    private void createRequestInterface(Context context) {
        ...
        acceptTextView.setTypeface(AndroidUtilities.getTypeface("fonts/rregular.ttf"));
    ...
    private void createManageInterface(Context context) {
        ...
        emptyTextView1.setTypeface(AndroidUtilities.getTypeface("fonts/rregular.ttf"));
        ...
        emptyTextView3.setTypeface(AndroidUtilities.getTypeface("fonts/rregular.ttf"));
        emptyTextView3.setGravity(Gravity.CENTER);
        ...
        public void setParams(Bundle params, boolean restore) {
            ...
            if (codeField == null || codeField.length != length) {
                ...
                for (int a = 0; a < length; a++) {
                    ...
                    codeField[a].setTypeface(AndroidUtilities.getTypeface("fonts/rregular.ttf"));
