...
import com.yomi.messenger.components.ChatActivityEnterViewStaticIconView;
import com.yomi.messenger.components.TranslateBeforeSendWrapper;
import com.yomi.messenger.boost.BoostController;
import com.yomi.messenger.boost.encryption.EncryptionHelper;
...
//        });
    ...
    private void createCaptionLimitView() {
        ...
        captionLimitView.setTypeface(AndroidUtilities.getTypeface(AndroidUtilities.TYPEFACE_ROBOTO_REGULAR));
    ...
    private class SlideTextView extends View {
        ...
        public SlideTextView(@NonNull Context context) {
            ...
            bluePaint.setTypeface(AndroidUtilities.getTypeface(AndroidUtilities.TYPEFACE_ROBOTO_REGULAR));
