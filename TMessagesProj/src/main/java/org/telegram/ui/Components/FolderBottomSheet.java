...
public class FolderBottomSheet extends BottomSheetWithRecyclerListView {
    ...
    private static class Button extends FrameLayout {
        ...
        public Button(Context context, String string) {
            ...
            text.setTypeface(AndroidUtilities.getTypeface(AndroidUtilities.TYPEFACE_ROBOTO_REGULAR));
            ...
            countText.setTypeface(AndroidUtilities.getTypeface(AndroidUtilities.TYPEFACE_ROBOTO_REGULAR));
...
//            } catch (Exception ignore) {}
        ...
        private class FoldersPreview extends View {
            ...
            public FoldersPreview(
                ...
                selectedTextPaint.setTypeface(AndroidUtilities.getTypeface(AndroidUtilities.TYPEFACE_ROBOTO_REGULAR));
