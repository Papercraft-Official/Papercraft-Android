...
public class PickerBottomLayout extends FrameLayout {
    ...
    public PickerBottomLayout(Context context, boolean darkTheme, Theme.ResourcesProvider resourcesProvider) {
        ...
        doneButtonBadgeTextView.setTypeface(AndroidUtilities.getTypeface("fonts/rregular.ttf"));
        ...
        doneButtonTextView.setTypeface(AndroidUtilities.getTypeface("fonts/rregular.ttf"));
