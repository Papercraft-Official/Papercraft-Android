...
public class CalendarActivity extends BaseFragment {
    ...
    public View createView(Context context) {
        ...
        textPaint2.setTypeface(AndroidUtilities.getTypeface("fonts/rregular.ttf"));

        activeTextPaint.setTextSize(AndroidUtilities.dp(16));
        activeTextPaint.setTypeface(AndroidUtilities.getTypeface("fonts/rregular.ttf"));
        ...
        if (showBottomPanel) {
            ...
            selectDaysButton.setTypeface(AndroidUtilities.getTypeface("fonts/rregular.ttf"));
            ...
            removeDaysButton.setTypeface(AndroidUtilities.getTypeface("fonts/rregular.ttf"));
