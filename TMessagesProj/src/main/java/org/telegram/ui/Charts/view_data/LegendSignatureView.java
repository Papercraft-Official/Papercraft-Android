...
public class LegendSignatureView extends FrameLayout {
    ...
    public LegendSignatureView(Context context) {
        ...
        time.setTypeface(AndroidUtilities.getTypeface("fonts/rregular.ttf"));
        hourTime = new TextView(context);
        hourTime.setTextSize(TypedValue.COMPLEX_UNIT_DIP, 14);
        hourTime.setTypeface(AndroidUtilities.getTypeface("fonts/rregular.ttf"));
    ...
    class Holder {
        ...
        Holder() {
            ...
            if (showPercentage) {
                ...
                percentage.setTypeface(AndroidUtilities.getTypeface("fonts/rregular.ttf"));
            ...
            value.setTypeface(AndroidUtilities.getTypeface("fonts/rregular.ttf"));
