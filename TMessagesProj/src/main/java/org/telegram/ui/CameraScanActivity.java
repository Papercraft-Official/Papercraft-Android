                ...
                if (currentType == TYPE_QR || currentType == TYPE_QR_WEB_BOT) {
                    ...
                    for (int i = 0; i < links.length; ++i) {
                        ...
                        if (index1 != -1 && index2 != -1 && index1 != index2) {
                            ...
                            spanned.setSpan(new TypefaceSpan(AndroidUtilities.getTypeface(AndroidUtilities.TYPEFACE_ROBOTO_REGULAR)), index1, index2 - 1, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
                        } else {
                            break;
                        }
                    }
